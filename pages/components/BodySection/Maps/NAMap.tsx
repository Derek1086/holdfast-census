      ...
      >
        <g transform={`translate(${offset.x},${offset.y})`}>
          ...
          <path
            ...
            onMouseLeave={mouseLeaveHandler}
            onClick={mouseClickHandler}
            d="M713.1 395.9l-8.6 11.2-8.7 11.2-13 17-0.9 1-9.9 10.4 0.3 36.3 0 4.8 0 4.2-0.1 0.2-5.1 0.1-10.8-0.1-11.4-0.3-8.5-0.3-12.1-0.6 0-17.4 0-23 0.1-10.3 0.1-15.6 0.2-15.6 3.4-51.6 8.5 0.4 8.5 0.4 5.6 0.2 11.3 0.2 11.3-0.1 0.2 2.8-0.2 1.6 0.7 3.6-0.4 0.8-0.1 3.5 0.7 0.5 0 0.8 1.4 1.2 0.6 1.3 1.6-0.7 1.7 0.1 1-0.5 3.4 0.3 0.4 1 0.1 1.9 1.2 3.3 1.1 2.2 0.4 2.6 2.2 5.1 0.3 1.1-0.2 1.7-0.5 1.4-0.8 1.4 2.6-0.9 0.4 0.5 1.7-0.6 1.3-0.7 4.8-2.1 1.2 0 1.8 0.3 3.5 1.8 0.8 0.7 0.9 0.3 2.9 0.3 2.4 0.9 0.7-0.2z"
            id="MB"
            name="Manitoba"
            fill={updateColorHandler("MB")}
          ></path>
          <path
            onMouseEnter={mouseEnterHandler}
            onMouseLeave={mouseLeaveHandler}
            onClick={mouseClickHandler}
            d="M624.3 491l-11.7-0.8-9.1-0.7-9.5-0.9-6.8-0.7-8.5-1-6.7-0.9-6.8-1-7.4-1.1 0-0.1 20.4-131.9 6.2 1 6.3 0.8 6.2 0.8 6.2 0.7 6.3 0.7 6.2 0.6 6.3 0.5 6.2 0.5-3.4 51.6-0.2 15.6-0.1 15.6-0.1 10.3 0 23 0 17.4z"
            id="SK"
            name="Saskatchewan"
          ...
          <path
            ...
            onMouseLeave={mouseLeaveHandler}
            onClick={mouseClickHandler}
            d="M836.5 593.5l-0.1-0.6-0.1-0.1-0.4-0.4-0.6-0.2 0.6-0.9 1.4 0.9-0.8 1.3z"
            id="DC"
            name="District of Columbia"
            fill={updateColorHandler("DC")}
          ></path>
        ...
        <circle cx="322.1" cy="615.6" id="6"></circle>
        <circle cx="286.3" cy="608" id="7"></circle>
        <circle cx="264.3" cy="605.8" id="8"></circle>
        <circle cx="857.8" cy="565.8" id="0"></circle>
        <circle cx="834.7" cy="749.5" id="1"></circle>
        <circle cx="459.4" cy="658.2" id="2"></circle>
        <g id="layer3">
          <circle className="Manitoba" cx="656.4" cy="417.8" id="MB"></circle>
          <circle
            className="Saskatchewan"
            cx="595.6"
            cy="425.6"
            id="SK"
          ></circle>
          <circle className="Alberta" cx="534.6" cy="407" id="AB"></circle>
          <circle
            className="British Columbia"
            cx="470.8"
            cy="383.5"
            id="BC"
          ></circle>
          <circle className="Nunavut" cx="652" cy="289.5" id="NU"></circle>
          <circle
            className="Northwest Territories"
            cx="528.4"
            cy="293.2"
            id="NT"
          ></circle>
          <circle className="Yukon" cx="438.5" cy="275.6" id="YT"></circle>
          <circle className="Ontario" cx="729.8" cy="452.6" id="ON"></circle>
          <circle className="Québec" cx="833.9" cy="431.3" id="QC"></circle>
          <circle
            className="New Brunswick"
            cx="900.6"
            cy="483.3"
            id="NB"
          ></circle>
          <circle
            className="Nova Scotia"
            cx="918.3"
            cy="502.8"
            id="NS"
          ></circle>
          <circle
            className="Newfoundland and Labrador"
            cx="901.1"
            cy="384.5"
            id="NL"
          ></circle>
          <circle
            className="Prince Edward Island"
            cx="923.5"
            cy="476.6"
            id="PE"
          ></circle>
          <circle
            className="Massachusetts"
            cx="871.3"
            cy="542.4"
            id="MA"
          ></circle>
          <circle className="Minnesota" cx="677.5" cy="520.6" id="MN"></circle>
          <circle className="Montana" cx="557.2" cy="507.5" id="MT"></circle>
          <circle
            className="North Dakota"
            cx="630.3"
            cy="509.3"
            id="ND"
          ></circle>
          <circle className="Idaho" cx="509.2" cy="540.2" id="ID"></circle>
          <circle className="Washington" cx="476.8" cy="485" id="WA"></circle>
          <circle className="Arizona" cx="516.2" cy="650.8" id="AZ"></circle>
          <circle className="California" cx="447.7" cy="608.3" id="CA"></circle>
          <circle className="Colorado" cx="579.7" cy="604.6" id="CO"></circle>
          <circle className="Nevada" cx="481.5" cy="582.4" id="NV"></circle>
          <circle className="New Mexico" cx="569.4" cy="656.2" id="NM"></circle>
          <circle className="Oregon" cx="462" cy="524.9" id="OR"></circle>
          <circle className="Utah" cx="526.1" cy="595.7" id="UT"></circle>
          <circle className="Wyoming" cx="567.6" cy="556.2" id="WY"></circle>
          <circle className="Arkansas" cx="699.3" cy="655.2" id="AR"></circle>
          <circle className="Iowa" cx="687.5" cy="573.4" id="IA"></circle>
          <circle className="Kansas" cx="644.2" cy="614.6" id="KS"></circle>
          <circle className="Missouri" cx="697.5" cy="617.3" id="MO"></circle>
          <circle className="Nebraska" cx="632.8" cy="579.3" id="NE"></circle>
          <circle className="Oklahoma" cx="656.4" cy="650.3" id="OK"></circle>
          <circle
            ...
            id="SD"
          ></circle>
          <circle className="Louisiana" cx="699.3" cy="691" id="LA"></circle>
          <circle className="Texas" cx="642.5" cy="701.4" id="TX"></circle>
          <circle className="Connecticut" cx="866" cy="552.6" id="CT"></circle>
          <circle
            className="New Hampshire"
            cx="869.3"
            cy="529"
            id="NH"
          ></circle>
          <circle
            className="Rhode Island"
            cx="875.3"
            cy="549.4"
            id="RI"
          ></circle>
          <circle className="Vermont" cx="858.7" cy="524.8" id="VT"></circle>
          <circle className="Alabama" cx="756.2" cy="677.6" id="AL"></circle>
          <circle className="Florida" cx="813.1" cy="719.2" id="FL"></circle>
          <circle className="Georgia" cx="790.9" cy="675.4" id="GA"></circle>
          <circle
            className="Mississippi"
            cx="727.7"
            cy="679.7"
            id="MS"
          ></circle>
          <circle
            ...
            id="SC"
          ></circle>
          <circle className="Illinois" cx="724.8" cy="593" id="IL"></circle>
          <circle className="Indiana" cx="753.5" cy="594.2" id="IN"></circle>
          <circle className="Kentucky" cx="772.2" cy="617" id="KY"></circle>
          <circle
            ...
            id="NC"
          ></circle>
          <circle className="Ohio" cx="781" cy="587.7" id="OH"></circle>
          <circle className="Tennessee" cx="756.7" cy="641.3" id="TN"></circle>
          <circle className="Virginia" cx="822.2" cy="611.8" id="VA"></circle>
          <circle className="Wisconsin" cx="715.9" cy="539.3" id="WI"></circle>
          <circle
            className="West Virginia"
            cx="803.4"
            cy="601.7"
            id="WV"
          ></circle>
          <circle className="Delaware" cx="851" cy="591.6" id="DE"></circle>
          <circle
            className="District of Columbia"
            cx="836.4"
            cy="592.2"
            id="DC"
          ></circle>
          <circle className="Maryland" cx="836" cy="587" id="MD"></circle>
          <circle className="New Jersey" cx="854.8" cy="577.3" id="NJ"></circle>
          <circle className="New York" cx="844.7" cy="541.3" id="NY"></circle>
          <circle
            className="Pennsylvania"
            cx="824.8"
            cy="571.4"
            id="PA"
          ></circle>
          <circle className="Maine" cx="882.7" cy="502.6" id="ME"></circle>
          <circle className="Michigan" cx="760.2" cy="556.5" id="MI"></circle>
          <circle className="Alaska" cx="383.4" cy="199.1" id="AK"></circle>
        </g>
      </svg>
    </>
  );
